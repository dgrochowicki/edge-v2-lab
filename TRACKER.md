...
|---|---|---|---|---:|---:|---:|---:|---|---:|---:|
| 1 | 2026-09-23 | Just Players vs Bushido Wildcats | Bushido Wildcats ML | 1.70 | 64–67%* | 1.49–1.56* | MEDIUM | LOSS (-3.00 PLN) | N/R | N/A |
...
`*` Bet #1's pre-match estimate remains frozen for experiment integrity, but the post-match audit found that it was not sufficiently supported because a material Bushido roster substitution had not been correctly verified before BET.
